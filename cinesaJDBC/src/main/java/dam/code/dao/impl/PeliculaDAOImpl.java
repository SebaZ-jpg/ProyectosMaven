...
public class PeliculaDAOImpl implements PeliculaDAO {
    ...
    public void registrar(Pelicula pelicula) throws PeliculaException {
        String sql = "INSERT INTO peliculas (titulo, director, diuracion, fecha de publicacion) VALUES (?, ?, ?, ?)";
    ...
    public List<Pelicula> listar() throws PeliculaException {
        //lista de peliculas que inicializa vacia
        ...
        try(Connection con = DatabaseConfig.getConnection();
            ...
            //completa toda la informacion si existe, si no, no
            while (rs.next()){
